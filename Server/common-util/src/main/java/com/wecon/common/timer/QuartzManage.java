...
public class QuartzManage {
     ...
     * @throws SchedulerException
     */
    public static void createJob(Scheduler scheduler, Trigger trigger, String jobName, String groupName,
            Object colBean, Class jobClass) throws SchedulerException {
