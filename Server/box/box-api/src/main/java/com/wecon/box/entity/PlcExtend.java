...
public class PlcExtend extends PlcInfo{
    ...
    public static final String[] UPDATE_PLC_FIELD_FILTER = new String[]{"com", "upd_time", "type", "driver", "box_stat_no", "plc_stat_no", "port", "comtype", "baudrate", "stop_bit", "data_length",
