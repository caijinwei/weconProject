...
public class AccountRelationImpl implements AccountRelationApi {
    ...
    public List<AccountRelation> getAccountRelationByManagerAccId(long managerId) {
        String sql = "select  " + SEL_COL + " from account_relation where manager_id=? ";
        return jdbcTemplate.query(sql, new Object[]{managerId}, new DefaultAccountRelationRowMapper());
    }
