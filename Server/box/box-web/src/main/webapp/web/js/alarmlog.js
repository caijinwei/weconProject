				...
				function($scope, $http, $compile) {
					...
					$scope.exportExcel = function(state) {
						...
						if(1 == state){
							...
							myform.innerHTML = '<input type="hidden" name="pageIndex" value="'+pageIndex+'"/>' +
							...
							myform.innerHTML = '<input type="hidden" name="alarm_cfg_id" value="'+alarm_cfg_id+'"/>' +
									'<input type="hidden" name="alarmcfgname" value="'+alarmcfgname+'"/>' +
						...
						myform.action = 'http://localhost:8080/box-web/api/excelact/filedownloadExportAlarm';
