...
public class JettyFactory {
    ...
    private static final String DEFAULT_WEBAPP_PATH = "E:/workspace/PIBox/Server/box/box-data-web/src/main/webapp";//src/main/webapp
    //private static final String WINDOWS_WEBDEFAULT_PATH = "jetty/webdefault-windows.xml";
    private static final String WINDOWS_WEBDEFAULT_PATH = "E:/workspace/PIBox/Server/box/box-data-web/src/main/webapp/WEB-INF/web-test.xml";//src/main/webapp/WEB-INF/web-test.xml
