...
public class DeviceAction {
	...
	public Output showAllDeviceDir(@RequestParam("pageNum") Integer pageNum, @RequestParam("pageSize") Integer pageSize,
			@RequestParam("accountId") String accountId, @RequestParam("bind_state") Integer bind_state,
			@RequestParam("machine_code") String machine_code, @RequestParam("state") Integer state) {
		...
		if (!machine_code.equals("-1")) {
			...
			if (bind_state == 1) {
				...
				page = deviceApi.getDeviceByUnbound(state, pageNum, pageSize);
			}
		} else {
